...
public interface TagService {
    ...
    ApiResponseMsgWthStatus createTagByReqParamsAndGetApiResponse(String tag);

    ApiResponseWithPagination getAllTagsByPagination(String title, int page, int size, String[] sort);
}
